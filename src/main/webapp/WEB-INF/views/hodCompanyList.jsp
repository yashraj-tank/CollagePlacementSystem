...
<head>
    <meta charset="UTF-8">
    <title>Companies - ${hod.branch}</title>
    <style>
...
<body>
    ...
    <div class="main-content">
        <div class="container">
            <h2>Companies Recruiting in ${hod.branch}</h2>
            <c:choose>
            ...
            <div style="text-align: center;">
                <a href="${pageContext.request.contextPath}/hod/dashboard" class="btn-back">Back to Dashboard</a>
            </div>
        </div>
    </div>
</body>
